...
const Contact = () => {
  return (
    ...
    space-y-8 lg:space-y-0 lg:space-x-8 items-center' id="contact">
      <div className='flex justify-center items-center'>
        <ul className='space-y-4'>
          <li className='flex items-center'>
            <Image src={phone} alt="phone" className='h-[110px] w-auto mr-6'/>
             <p className='text-xl'>+977 9827188327</p>
          </li>
          <li className='flex items-center'>
            <Image src={mail} alt="mail" className='h-[110px] w-auto mr-6'/>
             <p className='text-xl'>binayaparajuli17@gmail.com</p>
          </li>
        </ul>
      ...
      <div className='bg-white/10 p-6 rounded-xl max-w-[550px]'>
        ...
        <form className='space-y-4' action="https://getform.io/f/bgddzlva" method="POST">
