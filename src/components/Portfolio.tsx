...
const projects = [
    {title:"E-commerce", description:"This is a ecommerce website", devStack:["django", "python"], git:"", src:project1, link:"#"},
    {title:"Todo", description:"This is a todo website", devStack:["react", "nextjs", "typescript"], git:"", src:project2, link:"#"}
]
const Portfolio = () => {
  return (
        ...
        <div className='max-w-[1000px] mx-auto mt-40 space-y-24'>
            {projects.map((project, index)=> (
                <motion.div
                    ...
                    className={`mt-12 flex ${index % 2 === 1 ? "flex-col-reverse md:flex-row-reverse gap-12" 
                    : "flex-col md:flex-row"}`}
                >
                    <div className='space-y-2 max-w-[550px]'>
                        <h2 className='text-7xl my-4 text-white/70'>{`0${index +1}`}</h2>
                        <h2 className="text-7xl">{project.title}</h2>
                        <p className='tex-lg text-white/70 break-words p-4'>{project.description}</p>
